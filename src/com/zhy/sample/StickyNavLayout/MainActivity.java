...
public class MainActivity extends FragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		ViewConfiguration vConfiguration=ViewConfiguration.get(this);
		vConfiguration.getScaledTouchSlop();
		initViews();
		initDatas();
		initEvents();
	}
	...
	private void initDatas()
	{
		...
		mFragments[0]=SummaryFragment.create();
	...
	private void initViews()
	{
		...
		mIndicator.setmPager(mViewPager);
	}
